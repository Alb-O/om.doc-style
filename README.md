...
Write competent & professional prose, not shopping lists with a technical guise.
...
✓ Name the mechanism. Don't say "handles this automatically"; say "recursively walks the directory tree and converts each `.nix` file to an attrset path".
